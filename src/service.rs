...
use futures::prelude::*;
use dothereum_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			dothereum_runtime::opaque::Block, dothereum_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, dothereum_runtime::RuntimeApi, _, _>(

...
/// Dothereum `ChainSpec` extensions.
///
...
/// Dothereum Beta testnet generator
pub fn beta_xth_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../res/beta-xth.json")[..])
}
/// Dothereum Gamma testnet generator
pub fn gamma_xth_config() -> Result<ChainSpec, String> {
